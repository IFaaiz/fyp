...
Read each **current message**, select every applicable classification label, then drag over useful text in the subject or current message and choose a span type. Use **Needs review** with a short note when the evidence is unclear. Progress saves automatically. Use Previous, Next, or Jump to unfinished; reopening resumes at the first unfinished email.
